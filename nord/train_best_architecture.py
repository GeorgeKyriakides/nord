...
from neural_nets import LocalEvaluator,  NeuralNet
...
ne = LocalEvaluator(torch.optim.Adamax, {'weight_decay': 1e-5}, verbose=True)
...
fitness = ne.net_evaluate(
    nn, 20, data_percentage=1, dataset=dataset)
torch.cuda.empty_cache()

print(fitness)
torch.save(nn.state_dict(), 'best_architecture_state.dict')
